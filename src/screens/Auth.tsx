  ...
  const handleAuth = async () => {
    ...
    try {
      if (isLogin) {
        ...
        if (userDoc.exists()) {
          onLoginSuccess(userDoc.data().gymName);
        } else {
          onLoginSuccess("Royal Gym");
        }
      } else {
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        {/* overlay में pointerEvents="box-none" टच फिक्स के लिए है */}
        <View style={styles.overlay} pointerEvents="box-none">
          ...
          >
            <ScrollView 
              ...
              keyboardShouldPersistTaps="always" // पक्का करता है कि इनपुट पर क्लिक हो
...
const styles = StyleSheet.create({
  ...
  logoCircle: { 
    width: 85, height: 85, backgroundColor: 'rgba(255,255,255,0.15)', 
  ...
  glassCard: { 
    ...
    borderRadius: 35, padding: 25, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)',
    zIndex: 999, // सबसे ऊपर
    elevation: 10
  },
  ...
  inputWrapper: { 
    ...
    borderRadius: 20, paddingHorizontal: 15, height: 60, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' 
  },
  ...
  mainBtn: { 
    ...
    alignItems: 'center', height: 65, borderRadius: 20, gap: 10, marginTop: 5,
